                ...
                <asp:MultiView ID="MultiView1" ActiveViewIndex="0" runat="server">
                    <asp:View ID="View1" runat="server">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" DataKeyNames="name" OnRowCommand="GridView1_SelectedIndexChanged" HeaderStyle-HorizontalAlign="Center"
                                    ...
                                    RowStyle-HorizontalAlign="left" RowStyle-VerticalAlign="Middle" HeaderStyle-VerticalAlign="Middle" Height="200px" Width="100%" CssClass="text-center"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:ButtonField ButtonType="Button" CommandName="Select" HeaderText="Flyer" ShowHeader="True" Text="Generate Flyer" ControlStyle-CssClass="btn btn-primary btn-lg" />
                                    </Columns>
                    ...
                    <asp:View ID="View2" runat="server">
                        <table>
                            ...
                            <tr>
                                <td>
                                    <asp:DetailsView ID="DetailsView1" runat="server" DataSourceID="SqlDataSource2" CellPadding="4" CellSpacing="5" ForeColor="#333333" GridLines="None" Height="143px" Width="500px"
                                        ...
                                        <Fields>
                                            <asp:BoundField DataField="name" HeaderText="Thesis" SortExpression="name" />
                            ...
                            <tr>
                                <td align="right">
                                    <asp:Button ID="Button1" runat="server" Text="Print" OnClientClick="javascript:window.print()" CssClass="btn btn-success btn-lg no-print" />
                                </td>
                            </tr>
                        </table>
                    </asp:View>
