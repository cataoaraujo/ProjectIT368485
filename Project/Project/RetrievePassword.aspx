<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="RetrievePassword.aspx.cs" Inherits="Project.RetrievePassword" %>
    ...
    <div class="container well">
        ...
        <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
            ...
            <tr>
                ...
                <td><asp:TextBox ID="confirmPwd" TextMode="Password" runat="server"></asp:TextBox></td>
