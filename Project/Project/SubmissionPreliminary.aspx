<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SubmissionPreliminary.aspx.cs" Inherits="FinalProject.SubmissionPreliminary" %>
    ...
    <div class="container">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h1>Submission of Preliminary Proposal</h1>
            </div>
